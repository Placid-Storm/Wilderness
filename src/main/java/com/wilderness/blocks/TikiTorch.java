...
public class TikiTorch extends BlockContainer {

	public TikiTorch(Material material) {
		super(material);
		this.setBlockName("TikiTorch");
		this.setCreativeTab(ModCreativeTabs.tabTools);
		this.setBlockTextureName(RefStrings.MODID + ":TikiTorch");
