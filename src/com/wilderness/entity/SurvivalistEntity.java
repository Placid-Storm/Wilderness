...
public class SurvivalistEntity extends EntityMob{
    ...
    public SurvivalistEntity(World par1World)
    {
        super(par1World);
    ...
    public IEntityLivingData onSpawnWithEgg(IEntityLivingData par1EntityLivingData)
    {
        ...
        {
            par1EntityLivingData1 = new SurvivalistEntity.GroupData(this.worldObj.rand.nextFloat() < ForgeModContainer.zombieBabyChance, this.worldObj.rand.nextFloat() < 0.05F, null);
        }

        if (par1EntityLivingData1 instanceof SurvivalistEntity.GroupData)
        {
        	SurvivalistEntity.GroupData groupdata = (SurvivalistEntity.GroupData)par1EntityLivingData1;
